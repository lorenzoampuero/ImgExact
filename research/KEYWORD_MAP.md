...
6. **Canonical origin:** `SITE.url` (placeholder `https://imgexact.com` until domain purchase — see `BRAND_OPTIONS.md`; replace before deploy). Self-referencing canonical on every indexable page.
